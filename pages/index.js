    ...
    <div className="min-h-screen px-3">
      ...
      <div className="h-screen flex flex-col items-center justify-center">
        <main className="container px-20 lg:px-56">
          ...
          <h1 className="text-secondary-100 text-9xl md:text-9xl font-bold">Mukul Rajpoot</h1>
          ...
          <p className="text-secondary-900 text-3xl md:text-4xl max-w-6xl">I’m a <span className="font-bold">Full-Stack Developer</span> based in Barielly, India specializing in building exceptional digital experiences. I enjoy using my skill-set to empower people to accomplish their goals.</p>
          <Link href="/contact">
