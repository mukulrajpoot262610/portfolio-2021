...
const About = () => {
    return (
        <div className="min-h-screen px-3">
            ...
            <div className="min-h-screen flex flex-col items-center justify-center">
                <div className="hidden h-1/4 container relative w-full md:flex justify-center items-center">
                    <h1 className="absolute bottom-0 text-transparent" style={{ WebkitTextStrokeWidth: '.5px', WebkitTextStrokeColor: 'var(--main-yellow)', fontSize: '15rem', zIndex: '-1' }}>&lt;toolbox /&gt; </h1>
                    <h1 className="text-secondary-100 font-extrabold" style={{ fontSize: '10rem' }} >Tech that I use</h1>
                </div>
                <main className="container px-20 lg:px-56">
                    <h3 className="text-success md:text-4xl">Some Technologies</h3>
            ...
            <div className="h-screen flex flex-col items-center justify-center">
                <div className="hidden h-1/4 container relative w-full md:flex justify-center items-center">
                    <h1 className="absolute bottom-0 text-transparent" style={{ WebkitTextStrokeWidth: '.5px', WebkitTextStrokeColor: 'var(--main-yellow)', fontSize: '15rem', zIndex: '-1' }}>&lt;About /&gt; </h1>
                    <h1 className="text-secondary-100 font-extrabold" style={{ fontSize: '10rem' }} >Why Me ?</h1>
                </div>
                <main className="container px-20 lg:px-56">
                    <h3 className="text-success md:text-4xl">About Me</h3>
                    ...
                    <h4 className="text-secondary-100 text-4xl md:text-5xl max-w-6xl my-8"> If you’ve got a project you’d like to work on with me just get in touch and we can get to work!
                    </h4>
